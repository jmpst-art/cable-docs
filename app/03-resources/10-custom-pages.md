...
Cable allows you to create completely custom pages for resources. To create a new page, you can use:

```bash
php artisan make:cable-page SortUsers --resource=UserResource --type=custom
```
