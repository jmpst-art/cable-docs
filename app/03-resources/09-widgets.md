...
Cable allows you to display widgets inside pages, below the header and above the footer.
...
```bash
php artisan make:cable-widget CustomerOverview --resource=CustomerResource
```

This command will create two files - a widget class in the `app/Cable/Resources/CustomerResource/Widgets` directory, and a view in the `resources/views/cable/resources/customer-resource/widgets` directory.
...
namespace App\Cable\Resources\CustomerResource\Pages;

use App\Cable\Resources\CustomerResource;
