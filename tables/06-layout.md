...
Both of these are possible with Cable. Tables automatically scroll horizontally when they overflow anyway, and you may choose to show and hide columns based on the responsive [breakpoint](https://tailwindcss.com/docs/responsive-design#overview) of the browser. To do this, you may use a `visibleFrom()` or `hiddenFrom()` method:
...
Thankfully, Cable lets you build responsive table-like interfaces, without touching HTML or CSS. These layouts let you define exactly where content appears in a table row, at each responsive breakpoint.
...
```php
use Cable\Tables\Columns\Layout\Split;
use Cable\Tables\Columns\TextColumn;
...
```php
use Cable\Tables\Columns\Layout\Split;
use Cable\Tables\Columns\Layout\Stack;
use Cable\Tables\Columns\ImageColumn;
use Cable\Tables\Columns\TextColumn;
...
```php
use Cable\Tables\Columns\Layout\Grid;
use Cable\Tables\Columns\TextColumn;
...
```php
use Cable\Tables\Columns\Layout\Panel;
use Cable\Tables\Columns\Layout\Split;
use Cable\Tables\Columns\Layout\Stack;
use Cable\Tables\Columns\ImageColumn;
use Cable\Tables\Columns\TextColumn;
...
Sometimes, you may find that your data fits into a grid format better than a list. Cable can handle that too!
...
```php
use Cable\Tables\Columns\Layout\Split;
use Cable\Tables\Columns\Layout\View;
use Cable\Tables\Columns\ImageColumn;
use Cable\Tables\Columns\TextColumn;
