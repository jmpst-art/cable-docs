...
```php
use Cable\Tables\Columns\Summarizers\Average;
...
```php
use Cable\Tables\Columns\Summarizers\Average;
use Cable\Tables\Columns\Summarizers\Range;
use Cable\Tables\Columns\TextColumn;
...
Cable ships with four types of summarizer:
...
use Cable\Tables\Columns\Summarizers\Count;
...
```php
use Cable\Tables\Columns\Summarizers\Sum;
use Cable\Tables\Columns\TextColumn;
...
```php
use Cable\Tables\Columns\Summarizers\Summarizer;
use Cable\Tables\Columns\TextColumn;
use Illuminate\Database\Query\Builder;
