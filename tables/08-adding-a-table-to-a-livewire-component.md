...
use Cable\Tables\Concerns\InteractsWithTable;
use Cable\Tables\Contracts\HasTable;
...
Cable is also able to guess which table columns you want in the table, based on the model's database columns. The `doctrine/dbal` package is required to use this functionality:
