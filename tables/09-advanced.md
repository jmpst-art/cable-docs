...
While Cable doesn't provide a direct integration with [Laravel Scout](https://laravel.com/docs/scout), you may override methods to integrate it.
...
With Cable, this allows you to store your table's filters, sort, search and pagination state in the URL.
