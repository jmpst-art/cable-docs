...
- `cable-notifications`
- `cable-notifications-notification`
- `cable-notifications-icon`
- `cable-notifications-title`
- `cable-notifications-close-button`
- `cable-notifications-date`
- `cable-notifications-body`
- `cable-notifications-actions`
...
Notification::configureUsing(function (Notification $notification): void {
    $notification->view('cable-notifications.notification');
});
```
...
```blade
<x-cable-notifications::notification :notification="$notification">
    {{-- Notification content --}}
</x-cable-notifications::notification>
```
...
use Cable\Notifications\Notification as BaseNotification;
