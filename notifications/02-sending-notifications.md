...
use Cable\Notifications\Notification; // [tl! focus]
...
```php
use Cable\Notifications\Actions\Action; // [tl! focus]
use Cable\Notifications\Notification;
...
```js
import { Notification, NotificationAction } from '../../vendor/cable/notifications/dist/index.js'
