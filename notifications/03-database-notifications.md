...
```php
use Cable\Notifications\Http\Livewire\Notifications;
...
Notifications::databaseNotifications();
Notifications::databaseNotificationsTrigger('cable-notifications.database-notifications-trigger');
```
...
```php
use Cable\Notifications\Events\DatabaseNotificationsSent;
use Cable\Notifications\Notification;
